...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Clause_any", "symbols": ["UnmarkedSubject", "Predicates_none"], "postprocess": makeBranch("clause_unmarked_subject")},
    {"name": "Clause_strict", "symbols": ["UnmarkedSubject", "Predicates_none"], "postprocess": makeBranch("clause_unmarked_subject")},
    ...
    {"name": "Preverb$ebnf$1", "symbols": ["WordNegator"], "postprocess": id},
    {"name": "Preverb$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "Preverb", "symbols": ["WordPreverb", "Preverb$ebnf$1"], "postprocess": makeBranchRightOptional("pv")},
    ...
    {"name": "Preposition$ebnf$1", "symbols": ["WordNegator"], "postprocess": id},
    {"name": "Preposition$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "Preposition", "symbols": ["WordPreposition", "Preposition$ebnf$1"], "postprocess": makeBranchRightOptional("preposition")},
